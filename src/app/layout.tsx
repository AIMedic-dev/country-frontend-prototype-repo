...
export default function RootLayout({
  ...
  return (
    <html lang="es">
      ...
      <body
        className={`${font} text-base sm:text-sm 2xl:text-base min-h-full text-white-1 bg-gradient-to-br w-screen max-h-screen  h-[100dvh] overflow-hidden from-blue-1  from-40%  to-blue-2 to-100% `}
